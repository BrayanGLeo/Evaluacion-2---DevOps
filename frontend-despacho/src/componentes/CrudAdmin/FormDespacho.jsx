...
export const FormDespacho = ({ venta, onClose }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      await axios.put(
        `http://innovatech-alb-210534167.us-east-1.elb.amazonaws.com:8080/api/v1/ventas/${venta.idVenta}`,
        jsonDataSales,
        {
          headers:{
      ...
      await axios.post("http://innovatech-alb-210534167.us-east-1.elb.amazonaws.com:8081/api/v1/despachos", jsonData, {
        headers:{
          'Content-Type': 'application/json',
          'Accept': 'application/json'
    }
